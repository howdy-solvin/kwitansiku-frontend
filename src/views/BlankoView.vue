                  ...
                  <div class="flex gap-[20px] items-center">
                    ...
                    <div class="relative w-[50%] bg-white border border-[#A2A2A2] rounded-md">
                      <div placeholder="Pilih nama pasien" :class="selectedNamaPasien ? 'text-black' : 'text-[#A2A2A2]'"
                        class="px-[10px] py-[11px] rounded-md w-full cursor-pointer" @click="toggleNamaPasien" readonly>
                        {{ selectedNamaPasien ? selectedNamaPasien : 'Pilih nama pasien' }}
                      </div>
                      <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400">
                        <i :class="dropdownListPasien
                      ...
                      <transition name="dropdown">
                        <div v-if="dropdownListPasien"
                          ...
                          <ul v-for="namaPasien in receipt.pasien_tkis" :key="namaPasien.id"
                            ...
                            <div role="status" v-if="
                              selectedNamaPasien === namaPasien.nama_lengkap &&
                              selectPasienLoading
                            ">
                              <svg aria-hidden="true" class="w-5 aspect-square text-gray-200 animate-spin fill-blue-600"
                  ...
                  <div class="flex gap-[13px] items-center w-full">
                    <div class="flex gap-[48px] items-center w-[40%]">
                      ...
                      <input id="tgl-lahir" v-model="pra_medical.data_diri.tgl_lahir" @input="inputPraMedical"
                        @change="calculateAge" type="date" placeholder="Pilih Nama Pasien"
                        class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md w-full" />
                    </div>
                    <label for="usia" class="min-w-max">Usia</label>
                    <input id="usia" v-model="pra_medical.data_diri.usia" disabled type="text" placeholder="0"
                    ...
                    <div class="relative border border-[#A2A2A2] rounded-md w-[150px] px-[10px] py-[11px]">
                      <div type="text" placeholder="Pilih nama pasien" :class="hasilPemeriksaan.pernihakan
                        ? 'text-black '
                      ...
                      <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400">
                        <i :class="dropDownStatusPernikahan
                          ? 'fas fa-chevron-down rotate-180'
                          : 'fas fa-chevron-down rotate-0'
                          " class="transition-transform duration-300 ease-in-out"></i>
                      </span>
                ...
                <section class="mt-[10px]">
                  <div class="bg-[#F4F4F4] flex flex-col gap-2 px-[16px] py-[13px] rounded-md">
                    ...
                    <div class="flex gap-[20px] items-center w-full">
                      ...
                      <output id="no-reg"
                        class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md w-full text-[#A2A2A2]">{{
                          pra_medical.data_diri.no_reg ? pra_medical.data_diri.no_reg : "No. Reg" }}</output>
                      <label for="tgl-daftar" class="min-w-max">Tgl & No. Daftar</label>
                      <output id="tgl-daftar"
                        class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md w-full text-[#A2A2A2]">{{
                          receipt.tanggal.split('T')[0] + '-' + receipt.no_pendaftaran }}</output>
                  ...
                  <div>
                    ...
                    <div class="mt-[10px] gap-[5px] flex items-center">
                      ...
                      <div class="relative border border-[#A2A2A2] rounded-md w-[100px] px-[10px] py-[11px]">
                        <div type="text" placeholder="Pilih nama pasien" :class="pra_medical.fisik.golongan_darah
                          ? 'text-black '
                          : 'text-[#A2A2A2] px-[10px] py-[11px]'
            ...
            <section class="baris-2">
              <div class="flex flex-col min-w-max">
                ...
                <div class="mt-[10px] gap-[5px] flex items-center">
                  ...
                  <div class="relative border border-[#A2A2A2] rounded-md w-[150px] px-[10px] py-[11px]">
                    <div type="text" placeholder="Pilih nama pasien" :class="hasilPemeriksaan.rontgen
                      ? 'text-black '
                      : 'text-[#A2A2A2] px-[10px] py-[11px]'
              ...
              <div class="flex flex-col">
                <div class="gap-[5px] flex items-center">
                  ...
                  <div class="relative border border-[#A2A2A2] rounded-md w-[150px] px-[10px] py-[11px]">
                    ...
                    <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400">
                      <i :class="dropDownHasilPemeriksaan
                        ? 'fas fa-chevron-down rotate-180'
                        : 'fas fa-chevron-down rotate-0'
                        " class="transition-transform duration-300 ease-in-out"></i>
                    </span>
                ...
                <div class="mt-[10px] gap-[5px] flex items-center">
                  ...
                  <h1 v-if="hasilPemeriksaan.hasil_pemeriksaan === 'Normal'" class="text-[20px] text-[#0075FF]">
                    FIT
                  </h1>
                  ...
                  <div class="flex gap-[20px] items-center">
                    ...
                    <div class="relative w-[50%] bg-white border border-[#A2A2A2] rounded-md">
                      ...
                      <transition name="dropdown">
                        <div v-if="dropdownListPasien"
                          class="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-md p-2 flex flex-col gap-2">
                          <ul v-if="listPasienFull.length > 0" v-for="pasien in receipt.pasien_tkis.filter((pasien) =>
                            listPasienFull.includes(pasien.uuid)
                          )" :key="pasien.id" @click="selectPasien(pasien.uuid, pasien.nama_lengkap)"
                            class="py-1 px-3 cursor-pointer flex justify-between items-center hover:bg-gray-100 border rounded-sm">
                          ...
                          <ul v-else class="py-1 px-3 cursor-not-allowed flex justify-between items-center rounded-sm">
          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[20px]">
            <section class="section1">
              <div class="grid-container gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.hiv_status" @input="inputFullMedical({ hiv_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hiv_status" @input="inputFullMedical({ hiv_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.hiv_date.split('T')[0]"
                  @input="inputFullMedical({ hiv_date: $event.target.value })" placeholder="Pilih Tanggal"
                ...
                <input type="checkbox" :checked="fullData.tbc_status" @input="inputFullMedical({ tbc_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.tbc_status" @input="inputFullMedical({ tbc_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.tbc_date.split('T')[0]"
                  @input="inputFullMedical({ tbc_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Malaria <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.malaria_status"
                  @input="inputFullMedical({ malaria_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.malaria_status"
                  @input="inputFullMedical({ malaria_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.malaria_date.split('T')[0]"
                  @input="inputFullMedical({ malaria_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Leprosy <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.leprosy_status"
                  @input="inputFullMedical({ leprosy_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.leprosy_status"
                  @input="inputFullMedical({ leprosy_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.leprosy_date.split('T')[0]"
                  @input="inputFullMedical({ leprosy_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">STD <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.std_status" @input="inputFullMedical({ std_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.std_status" @input="inputFullMedical({ std_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.std_date.split('T')[0]"
                  @input="inputFullMedical({ std_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Bronchial Asthma</label>
                <input type="checkbox" :checked="fullData.asma_status" @input="inputFullMedical({ asma_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.asma_status"
                  @input="inputFullMedical({ asma_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.asma_date.split('T')[0]"
                  @input="inputFullMedical({ asma_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />
              </div>
            </section>
            <section class="section2">
              <div class="grid-container gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.hd_status" @input="inputFullMedical({ hd_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hd_status" @input="inputFullMedical({ hd_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.hd_date.split('T')[0]"
                  @input="inputFullMedical({ hd_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Hypertension</label>
                <input type="checkbox" :checked="fullData.hypt_status" @input="inputFullMedical({ hypt_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hypt_status"
                  @input="inputFullMedical({ hypt_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.hypt_date.split('T')[0]"
                  @input="inputFullMedical({ hypt_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Diabetes Mellitus</label>
                <input type="checkbox" :checked="fullData.dbm_status" @input="inputFullMedical({ dbm_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.dbm_status" @input="inputFullMedical({ dbm_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.dbm_date.split('T')[0]"
                  @input="inputFullMedical({ dbm_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Peptic Ulcer</label>
                <input type="checkbox" :checked="fullData.ptu_status" @input="inputFullMedical({ ptu_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.ptu_status" @input="inputFullMedical({ ptu_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.ptu_date.split('T')[0]"
                  @input="inputFullMedical({ ptu_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Kidney Disease</label>
                <input type="checkbox" :checked="fullData.kidney_status"
                  @input="inputFullMedical({ kidney_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.kidney_status"
                  @input="inputFullMedical({ kidney_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.kidney_date.split('T')[0]"
                  @input="inputFullMedical({ kidney_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Cancer</label>
                <input type="checkbox" :checked="fullData.cancer_status"
                  @input="inputFullMedical({ cancer_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.cancer_status"
                  @input="inputFullMedical({ cancer_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.cancer_date.split('T')[0]"
                  @input="inputFullMedical({ cancer_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />
              </div>
            </section>
            <section class="section3">
              <div class="grid-container gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.epylepsy_status"
                  @input="inputFullMedical({ epylepsy_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.epylepsy_status"
                  @input="inputFullMedical({ epylepsy_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.epylepsy_date.split('T')[0]"
                  @input="inputFullMedical({ epylepsy_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Psychiatric Illnes <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.psin_status" @input="inputFullMedical({ psin_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.psin_status"
                  @input="inputFullMedical({ psin_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.psin_date.split('T')[0]"
                  @input="inputFullMedical({ psin_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Hearing Problem</label>
                <input type="checkbox" :checked="fullData.hepo_status" @input="inputFullMedical({ hepo_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hepo_status"
                  @input="inputFullMedical({ hepo_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.hepo_date.split('T')[0]"
                  @input="inputFullMedical({ hepo_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Hepatitis B & C <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.hpts_status" @input="inputFullMedical({ hpts_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hpts_status"
                  @input="inputFullMedical({ hpts_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.hpts_date.split('T')[0]"
                  @input="inputFullMedical({ hpts_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                <label class="">Other</label>
                <input type="checkbox" :checked="fullData.other_status"
                  @input="inputFullMedical({ other_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.other_status"
                  @input="inputFullMedical({ other_status: false })" class="h-[20px]" />
                <input type="date" :value="fullData.other_date.split('T')[0]"
                  @input="inputFullMedical({ other_date: $event.target.value })" placeholder="Pilih Tanggal"
                  class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />
              </div>
            </section>
          </div>
          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[20px]">
            <section class="section1">
              <div class="grid-container-2 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.snf_status" @input="inputFullMedical({ snf_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.snf_status" @input="inputFullMedical({ snf_status: false })"
                  class="h-[20px]" />

                <label class="">Nyeri dada saat beraktivitas
                  <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.nyd_status" @input="inputFullMedical({ nyd_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.nyd_status" @input="inputFullMedical({ nyd_status: false })"
                  class="h-[20px]" />

                <label class="">Debaran jantung <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.dbj_status" @input="inputFullMedical({ dbj_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.dbj_status" @input="inputFullMedical({ dbj_status: false })"
                  class="h-[20px]" />

                <label class="">Pembengkakan kaki</label>
                <input type="checkbox" :checked="fullData.pbk_status" @input="inputFullMedical({ pbk_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.pbk_status" @input="inputFullMedical({ pbk_status: false })"
                  class="h-[20px]" />

                <label class="">Rasa pusing karena sakit kepala
                  <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.rspks_status"
                  @input="inputFullMedical({ rspks_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.rspks_status"
                  @input="inputFullMedical({ rspks_status: false })" class="h-[20px]" />

                <label class="">Batuk lebih dari 2 minggu atau hemoptisis</label>
                <input type="checkbox" :checked="fullData.hmp_status" @input="inputFullMedical({ hmp_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hmp_status" @input="inputFullMedical({ hmp_status: false })"
                  class="h-[20px]" />
              </div>
            </section>
            <section class="section2">
              <div class="grid-container-2 gap-y-2 min-w-max items-center">
                ...
                <label class="">Kehilangan selera makan <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.ksm_status" @input="inputFullMedical({ ksm_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.ksm_status" @input="inputFullMedical({ ksm_status: false })"
                  class="h-[20px]" />

                <label class="">Rasa haus yang berlebihan dan sering buang air kecil
                  <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.rhb_sbk_status"
                  @input="inputFullMedical({ rhb_sbk_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.rhb_sbk_status"
                  @input="inputFullMedical({ rhb_sbk_status: false })" class="h-[20px]" />

                <label class="">Disuria, hematuria, dan gejala saluran kemih lainnya
                  <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.gskl_status" @input="inputFullMedical({ gskl_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.gskl_status"
                  @input="inputFullMedical({ gskl_status: false })" class="h-[20px]" />

                <label class="">Keluarnya cairan dari uretra/vagina
                  <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.kcuv_status" @input="inputFullMedical({ kcuv_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.kcuv_status"
                  @input="inputFullMedical({ kcuv_status: false })" class="h-[20px]" />

                <label class="">Nyeri sendi multipel <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.nsm_status" @input="inputFullMedical({ nsm_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.nsm_status" @input="inputFullMedical({ nsm_status: false })"
                  class="h-[20px]" />

                <label class="">Masalah penglihatan/buta warna</label>
                <input type="checkbox" :checked="fullData.mpbw_status" @input="inputFullMedical({ mpbw_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.mpbw_status"
                  @input="inputFullMedical({ mpbw_status: false })" class="h-[20px]" />
              </div>
            </section>
          </div>
          <p class="mt-5 text-[18px] font-bold">
          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[20px]">
            <section class="section1">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.rkk_status" @input="inputFullMedical({ rkk_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.rkk_status" @input="inputFullMedical({ rkk_status: false })"
                  class="h-[20px]" />

                <label>Pach kulit anestesi, pembesaran saraf tepi atau lesi nodular</label>
                <input type="checkbox" :checked="fullData.pkln_status" @input="inputFullMedical({ pkln_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.pkln_status"
                  @input="inputFullMedical({ pkln_status: false })" class="h-[20px]" />

                <label>Deformitas anggota badan</label>
                <input type="checkbox" :checked="fullData.dfab_status" @input="inputFullMedical({ dfab_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.dfab_status"
                  @input="inputFullMedical({ dfab_status: false })" class="h-[20px]" />

                <label>Anemia</label>
                <input type="checkbox" :checked="fullData.anemia_status"
                  @input="inputFullMedical({ anemia_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.anemia_status"
                  @input="inputFullMedical({ anemia_status: false })" class="h-[20px]" />

                <label>Penyakit kuning</label>
                <input type="checkbox" :checked="fullData.pkn_status" @input="inputFullMedical({ pkn_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.pkn_status" @input="inputFullMedical({ pkn_status: false })"
                  class="h-[20px]" />
              </div>
            </section>
            <section class="section2">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.tb_mt_kiri"
                  @input="inputFullMedical({ tb_mt_kiri: $event.target.checked })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.tb_mt_kanan"
                  @input="inputFullMedical({ tb_mt_kanan: $event.target.checked })" class="h-[20px]" />

                <label>Dengan bantuan</label>
                <input type="checkbox" :checked="fullData.db_mt_kiri"
                  @input="inputFullMedical({ db_mt_kiri: $event.target.checked })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.db_mt_kanan"
                  @input="inputFullMedical({ db_mt_kanan: $event.target.checked })" class="h-[20px]" />

                <label>Terdapat gangguan pendengaran</label>
                <input type="checkbox" :checked="fullData.tgp_kiri"
                  @input="inputFullMedical({ tgp_kiri: $event.target.checked })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.tgp_kanan"
                  @input="inputFullMedical({ tgp_kanan: $event.target.checked })" class="h-[20px]" />

                <label>Kebutaan warna</label>
                <input type="checkbox" :checked="fullData.kbw_kiri"
                  @input="inputFullMedical({ kbw_kiri: $event.target.checked })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.kbw_kanan"
                  @input="inputFullMedical({ kbw_kanan: $event.target.checked })" class="h-[20px]" />
              </div>
            </section>
          </div>
          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[16px]">
            <section class="section1">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.ukj_status" @input="inputFullMedical({ ukj_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.ukj_status" @input="inputFullMedical({ ukj_status: false })"
                  class="h-[20px]" />

                <label>Suara Jantung</label>
                <input type="checkbox" :checked="fullData.saj_status" @input="inputFullMedical({ saj_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.saj_status" @input="inputFullMedical({ saj_status: false })"
                  class="h-[20px]" />

                <div class="col-span-3 items-center grid-container-masukan-temuan">
                  <label class="col-span-1">Temuan Lain</label>
                  <input type="text" :value="fullData.tl_jantung"
                ...
                <input type="checkbox" :checked="fullData.sps_status" @input="inputFullMedical({ sps_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.sps_status" @input="inputFullMedical({ sps_status: false })"
                  class="h-[20px]" />

                <div class="col-span-3 items-center grid-container-masukan-temuan">
                  <label class="col-span-1">Temuan Lain</label>
                  <input type="text" :value="fullData.tl_sps" @input="inputFullMedical({ tl_sps: $event.target.value })"
                    class="col-span-3 w-full border border-[#A2A2A2] px-[10px] py-[9px] rounded-lg"
                    placeholder="Masukan Temuan" />
                </div>
                ...
                <label>Hati</label>
                <input type="checkbox" :checked="fullData.hati_status" @input="inputFullMedical({ hati_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.hati_status"
                  @input="inputFullMedical({ hati_status: false })" class="h-[20px]" />

                <label>Limpa</label>
                <input type="checkbox" :checked="fullData.limpa_status"
                  @input="inputFullMedical({ limpa_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.limpa_status"
                  @input="inputFullMedical({ limpa_status: false })" class="h-[20px]" />

                <label>Ginjal</label>
                <input type="checkbox" :checked="fullData.ginjal_status"
                  @input="inputFullMedical({ ginjal_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.ginjal_status"
                  @input="inputFullMedical({ ginjal_status: false })" class="h-[20px]" />

                <label>Apakah terjadi pembengkakan tidak normal? YA /TIDAK. Tunjukkan jika YA
                  .............</label>
                <input type="checkbox" :checked="fullData.pbk_sp_status"
                  @input="inputFullMedical({ pbk_sp_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.pbk_sp_status"
                  @input="inputFullMedical({ pbk_sp_status: false })" class="h-[20px]" />

                <input type="text" :value="fullData.tl_sp" @input="inputFullMedical({ tl_sp: $event.target.value })"
                  class="col-span-3 w-full border border-[#A2A2A2] px-[10px] py-[9px] rounded-lg"
                  placeholder="Masukan Temuan" />

                <label>Pemeriksaan Rektal (jika ada indikasi)</label>
                <input type="checkbox" :checked="fullData.pr_sp_status"
                  @input="inputFullMedical({ pr_sp_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.pr_sp_status"
                  @input="inputFullMedical({ pr_sp_status: false })" class="h-[20px]" />
              </div>
            </section>
            <section class="section2">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.smu_status" @input="inputFullMedical({ smu_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.smu_status" @input="inputFullMedical({ smu_status: false })"
                  class="h-[20px]" />

                <label>Berbicara</label>
                <input type="checkbox" :checked="fullData.berbicara_status"
                  @input="inputFullMedical({ berbicara_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.berbicara_status"
                  @input="inputFullMedical({ berbicara_status: false })" class="h-[20px]" />

                <label>Fungsi Kognitif</label>
                <input type="checkbox" :checked="fullData.fk_status" @input="inputFullMedical({ fk_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.fk_status" @input="inputFullMedical({ fk_status: false })"
                  class="h-[20px]" />

                <label>Ukuran saraf perifer</label>
                <input type="checkbox" :checked="fullData.usp_status" @input="inputFullMedical({ usp_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.usp_status" @input="inputFullMedical({ usp_status: false })"
                  class="h-[20px]" />

                <label>Kekuatan motorik</label>
                <input type="checkbox" :checked="fullData.km_status" @input="inputFullMedical({ km_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.km_status" @input="inputFullMedical({ km_status: false })"
                  class="h-[20px]" />

                <label>Sensorik</label>
                <input type="checkbox" :checked="fullData.sensorik_status"
                  @input="inputFullMedical({ sensorik_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.sensorik_status"
                  @input="inputFullMedical({ sensorik_status: false })" class="h-[20px]" />

                <label>Reflek</label>
                <input type="checkbox" :checked="fullData.reflek_status"
                  @input="inputFullMedical({ reflek_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.reflek_status"
                  @input="inputFullMedical({ reflek_status: false })" class="h-[20px]" />

                <h1 class="text-[16px] font-bold col-span-3">Pemeriksaan sistem genitourinari</h1>

                <label>Pembuangan</label>
                <input type="checkbox" :checked="fullData.psg_pbn_status"
                  @input="inputFullMedical({ psg_pbn_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.psg_pbn_status"
                  @input="inputFullMedical({ psg_pbn_status: false })" class="h-[20px]" />

                <label>Luka/Bisul</label>
                <input type="checkbox" :checked="fullData.luka_status" @input="inputFullMedical({ luka_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.luka_status"
                  @input="inputFullMedical({ luka_status: false })" class="h-[20px]" />
              </div>
            </section>
          </div>
          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[16px]">
            <section class="section1">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="!fullData.elisa_status"
                  @input="inputFullMedical({ elisa_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.elisa_status"
                  @input="inputFullMedical({ elisa_status: true })" class="h-[20px]" />

                <label>HBsAg <span class="text-red-500 text-[20px]">*</span> </label>
                <input type="checkbox" :checked="!fullData.hbsag_status"
                  @input="inputFullMedical({ hbsag_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.hbsag_status"
                  @input="inputFullMedical({ hbsag_status: true })" class="h-[20px]" />

                <label>HCT <span class="text-red-500 text-[20px]">*</span> </label>
                <input type="checkbox" :checked="!fullData.hct_status" @input="inputFullMedical({ hct_status: false })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="fullData.hct_status" @input="inputFullMedical({ hct_status: true })"
                  class="h-[20px]" />

                <label>VDRL & TPHA <span class="text-red-500 text-[20px]">*</span> </label>
                <input type="checkbox" :checked="!fullData.vdrl_tpha_status"
                  @input="inputFullMedical({ vdrl_tpha_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.vdrl_tpha_status"
                  @input="inputFullMedical({ vdrl_tpha_status: true })" class="h-[20px]" />

                <label>Parasit Malaria<span class="text-red-500 text-[20px]">*</span> </label>
                <input type="checkbox" :checked="!fullData.pama_status"
                  @input="inputFullMedical({ pama_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.pama_status" @input="inputFullMedical({ pama_status: true })"
                  class="h-[20px]" />

                <label>Parasit Filaria<span class="text-red-500 text-[20px]">*</span> </label>
                <input type="checkbox" :checked="!fullData.pafil_status"
                  @input="inputFullMedical({ pafil_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.pafil_status"
                  @input="inputFullMedical({ pafil_status: true })" class="h-[20px]" />
                ...
                <input type="checkbox" :checked="!fullData.ck_status" @input="inputFullMedical({ ck_status: false })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="fullData.ck_status" @input="inputFullMedical({ ck_status: true })"
                  class="h-[20px]" />

                <label class="col-span-3">Chest X-Ray Report (Valid For 6 month)</label>
                <input type="text" :value="fullData.cxray_report"
                  @input="inputFullMedical({ cxray_report: $event.target.value })"
                  class="col-span-3 w-full border border-[#A2A2A2] px-[10px] py-[9px] rounded-lg"
                  placeholder="Masukan Temuan" />

                <label>Sputum AFB (bila diindikasikan) </label>
                <input type="checkbox" :checked="!fullData.sptm_afb_status"
                  @input="inputFullMedical({ sptm_afb_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.sptm_afb_status"
                  @input="inputFullMedical({ sptm_afb_status: true })" class="h-[20px]" />

                <label class="col-span-3">Serum Kreatinin</label>
                <input type="text" :value="fullData.serum_krtnn"
            ...
            <section class="section2">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <div class="col-span-3 items-center grid-container-masukan-temuan">
                  ...
                  <input type="text" :value="fullData.warna_urin"
                ...
                <div class="col-span-3 items-center grid-container-masukan-temuan">
                  ...
                  <input type="text" :value="fullData.gravitasi_spesifik"
                ...
                <label>Gula</label>
                <input type="checkbox" :checked="!fullData.gula_status"
                  @input="inputFullMedical({ gula_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.gula_status" @input="inputFullMedical({ gula_status: true })"
                  class="h-[20px]" />

                <label>Albumin</label>
                <input type="checkbox" :checked="!fullData.albumin_status"
                  @input="inputFullMedical({ albumin_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.albumin_status"
                  @input="inputFullMedical({ albumin_status: true })" class="h-[20px]" />

                <div class="col-span-3 items-center grid-container-masukan-temuan">
                  <label class="col-span-1">Pemeriksaan miroskopi</label>
                  <input type="text" :value="fullData.pm_miros"
                ...
                <label>Opiat / Ganja / Amfetamin <span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.oga_status" @input="inputFullMedical({ oga_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.oga_status" @input="inputFullMedical({ oga_status: false })"
                  class="h-[20px]" />

                <label>Kehamilan<span class="text-red-500 text-[20px]">*</span></label>
                <input type="checkbox" :checked="fullData.kehamilan_status"
                  @input="inputFullMedical({ kehamilan_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.kehamilan_status"
                  @input="inputFullMedical({ kehamilan_status: false })" class="h-[20px]" />
                ...
                <input type="checkbox" :checked="fullData.urus_status" @input="inputFullMedical({ urus_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.urus_status"
                  @input="inputFullMedical({ urus_status: false })" class="h-[20px]" />
          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[16px]">
            <section class="section1">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="!fullData.stm_hiv_status"
                  @input="inputFullMedical({ stm_hiv_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_hiv_status"
                  @input="inputFullMedical({ stm_hiv_status: true })" class="h-[20px]" />

                <label>TBC</label>
                <input type="checkbox" :checked="!fullData.stm_tbc_status"
                  @input="inputFullMedical({ stm_tbc_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_tbc_status"
                  @input="inputFullMedical({ stm_tbc_status: true })" class="h-[20px]" />

                <label>Malaria</label>
                <input type="checkbox" :checked="!fullData.stm_malaria_status"
                  @input="inputFullMedical({ stm_malaria_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_malaria_status"
                  @input="inputFullMedical({ stm_malaria_status: true })" class="h-[20px]" />

                <label>Kusta</label>
                <input type="checkbox" :checked="!fullData.stm_kusta_status"
                  @input="inputFullMedical({ stm_kusta_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_kusta_status"
                  @input="inputFullMedical({ stm_kusta_status: true })" class="h-[20px]" />

                <label>PMS</label>
                <input type="checkbox" :checked="!fullData.stm_pms_status"
                  @input="inputFullMedical({ stm_pms_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_pms_status"
                  @input="inputFullMedical({ stm_pms_status: true })" class="h-[20px]" />

                <label>Hepatitis B</label>
                <input type="checkbox" :checked="!fullData.stm_hpb_status"
                  @input="inputFullMedical({ stm_hpb_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_hpb_status"
                  @input="inputFullMedical({ stm_hpb_status: true })" class="h-[20px]" />

                <label>Hepatitis C</label>
                <input type="checkbox" :checked="!fullData.stm_hpc_status"
                  @input="inputFullMedical({ stm_hpc_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_hpc_status"
                  @input="inputFullMedical({ stm_hpc_status: true })" class="h-[20px]" />

                <label>Filariasis</label>
                <input type="checkbox" :checked="!fullData.stm_filariasis_status"
                  @input="inputFullMedical({ stm_filariasis_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_filariasis_status"
                  @input="inputFullMedical({ stm_filariasis_status: true })" class="h-[20px]" />

                <label>Gangguan Psikiatri Utama</label>
                <input type="checkbox" :checked="!fullData.gpu_status" @input="inputFullMedical({ gpu_status: false })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="fullData.gpu_status" @input="inputFullMedical({ gpu_status: true })"
                  class="h-[20px]" />
                ...
                <input type="checkbox" :checked="!fullData.stm_pkl_status"
                  @input="inputFullMedical({ stm_pkl_status: false })" class="h-[20px]" />
                <input type="checkbox" :checked="fullData.stm_pkl_status"
                  @input="inputFullMedical({ stm_pkl_status: true })" class="h-[20px]" />
              </div>
            </section>
            <section class="section2">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="fullData.urine_oka_status"
                  @input="inputFullMedical({ urine_oka_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.urine_oka_status"
                  @input="inputFullMedical({ urine_oka_status: false })" class="h-[20px]" />

                <label>Dia sedang hamil</label>
                <input type="checkbox" :checked="fullData.dsh_status" @input="inputFullMedical({ dsh_status: true })"
                  class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.dsh_status" @input="inputFullMedical({ dsh_status: false })"
                  class="h-[20px]" />

                <label>Dia dalam keadaan sehat untuk bekerja</label>
                <input type="checkbox" :checked="fullData.sehat_bekerja_status"
                  @input="inputFullMedical({ sehat_bekerja_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.sehat_bekerja_status"
                  @input="inputFullMedical({ sehat_bekerja_status: false })" class="h-[20px]" />

                <label>Oleh karena itu, saya merekomendasikan agar dia dipertimbangkan untuk pekerjaan
                  tersebut</label>
                <input type="checkbox" :checked="fullData.rekom_status"
                  @input="inputFullMedical({ rekom_status: true })" class="h-[20px]" />
                <input type="checkbox" :checked="!fullData.rekom_status"
                  @input="inputFullMedical({ rekom_status: false })" class="h-[20px]" />
                ...
                <div v-if="!fullData.rekom_status" class="col-span-3 items-center">
                  ...
                  <textarea type="text" :value="fullData.rekom_alasan"
                    @input="inputFullMedical({ rekom_alasan: $event.target.value })"
                    class="w-full border border-[#A2A2A2] px-[10px] py-[9px] rounded-lg" placeholder="Berikan alasan" />
                </div>

                <label>Pilih nama dokter</label>
                <select :value="fullData.dokter" @input="inputFullMedical({ dokter: $event.target.value })"
                  class="col-span-3 w-full border border-[#A2A2A2] bg-white px-[10px] py-[9px] rounded-lg">
                  <option value="" disabled selected>Pilih Nama Dokter</option>
                ...
                <div class="items-center text-center col-span-3 grid-container-masaberlaku mt-[20px]">
                  ...
                  <input type="date" :value="fullData.masa_berlaku.split('T')[0]"
                    @input="inputFullMedical({ masa_berlaku: $event.target.value })" placeholder="Pilih Tanggal"
                    class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />

                  <label for="">Sampai Dengan</label>
                  <input type="date" :value="fullData.sampai_dengan.split('T')[0]"
                    @input="inputFullMedical({ sampai_dengan: $event.target.value })" placeholder="Pilih Tanggal"
                    class="border border-[#A2A2A2] px-[10px] py-[11px] rounded-md" />
                </div>
              </div>
            </section>
