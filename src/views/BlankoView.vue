          ...
          <div class="parent flex justify-between gap-[28px] px-5 mt-[20px]">
            <section class="section1">
              <div class="grid-container gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="!fullData.hiv_status" @input="inputFullMedical({ hiv_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.hiv_date ? fullData.hiv_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="checkbox" :checked="!fullData.tbc_status" @input="inputFullMedical({ tbc_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.tbc_date ? fullData.tbc_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.malaria_date ? fullData.malaria_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.leprosy_date ? fullData.leprosy_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="checkbox" :checked="!fullData.std_status" @input="inputFullMedical({ std_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.std_date ? fullData.std_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.asma_date ? fullData.asma_date.split('T')[0] : ''" @input="
                  inputFullMedical({
            ...
            <section class="section2">
              <div class="grid-container gap-y-2 min-w-max items-center">
                ...
                <input type="checkbox" :checked="!fullData.hd_status" @input="inputFullMedical({ hd_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.hd_date ? fullData.hd_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.hypt_date ? fullData.hypt_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="checkbox" :checked="!fullData.dbm_status" @input="inputFullMedical({ dbm_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.dbm_date ? fullData.dbm_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="checkbox" :checked="!fullData.ptu_status" @input="inputFullMedical({ ptu_status: false })"
                  class="h-[20px]" />
                <input type="date" :value="fullData.ptu_date ? fullData.ptu_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.kidney_date ? fullData.kidney_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.cancer_date ? fullData.cancer_date.split('T')[0] : ''" @input="
                  inputFullMedical({
            ...
            <section class="section3">
              <div class="grid-container gap-y-2 min-w-max items-center">
                ...
                <input type="date" :value="fullData.epylepsy_date ? fullData.epylepsy_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.psin_date ? fullData.psin_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.hepo_date ? fullData.hepo_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.hpts_date ? fullData.hpts_date.split('T')[0] : ''" @input="
                  inputFullMedical({
                ...
                <input type="date" :value="fullData.other_date ? fullData.other_date.split('T')[0] : ''" @input="
                  inputFullMedical({
            ...
            <section class="section2">
              <div class="grid-container-3 gap-y-2 min-w-max items-center">
                ...
                <div class="items-center text-center col-span-3 grid-container-masaberlaku mt-[20px]">
                  ...
                  <input type="date" :value="fullData.masa_berlaku ? fullData.masa_berlaku.split('T')[0] : ''"
                  ...
                  <input type="date" :value="fullData.sampai_dengan ? fullData.sampai_dengan.split('T')[0] : ''"
